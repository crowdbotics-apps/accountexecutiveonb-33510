...
## Project Structure
    ...
    ├── accountexecutiveonb_33510  # Django project configurations
...
1. Clone this repo and `cd accountexecutiveonb_33510`
...
2. Clone this repo and `cd accountexecutiveonb_33510`
